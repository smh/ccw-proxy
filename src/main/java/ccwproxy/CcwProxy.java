...
public class CcwProxy {
    ...
    public static void main(String[] args) {
        ...
        if (userInfo == null || !userInfo.contains(":")) {
            System.err.println("ERROR: Proxy URL must include username and password (format: http://user:pass@host:port)");
            System.exit(1);
        }
        ...
        System.out.println("[ccw-proxy] listening on " + listenHost + ":" + listenPort +
